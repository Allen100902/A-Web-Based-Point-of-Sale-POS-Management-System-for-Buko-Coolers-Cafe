<?php
    ...
    $archive_check = "SELECT PK_USER, FIRST_NAME, LAST_NAME, EMAIL, PNUM, USR_ADD, USERNAME, USER_PASSWORD, ROLE, EMPLOYEE_STATUS, DATE(LAST_USR_UDATE) AS 'LAST_USR_UDATE' FROM tbl_users WHERE EMPLOYEE_STATUS = 'ARCHIVED'";
...
<!DOCTYPE html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>User Archives - Buko Coolers Cafe</title>
                                ...
                                <?php
                                    if (mysqli_num_rows($exec_showarchive) > 0) {
                                        while($row = mysqli_fetch_assoc($exec_showarchive)){
                                            ...
                                            echo "<td>$return_user_udate</td>";
                                        }
                                    } else {
                                        echo "<tr>
                                            <td colspan='10'>No archived users found.</td>
                                            </tr>";
                                    }
                                ?>
                            </tr>
