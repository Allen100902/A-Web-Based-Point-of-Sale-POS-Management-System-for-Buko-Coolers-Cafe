<?php
    ...
    $show_inventory_rm = "SELECT PK_INVENTORY_ITEM, INVENTORY_ITEM_CODE, INVENTORY_ITEM_NAME, INVENTORY_ITEM_AMOUNT, INVENTORY_ITEM_UNITS, INVENTORY_ITEM_STOCK_MIN, INVENTORY_ITEM_COG, INVENTORY_ITEM_EXP, DATE_FORMAT(DATE_ADD(INVENTORY_ITEM_TIMESTAMP, INTERVAL 8 HOUR), '%Y-%m-%d') AS 'INVENTORY_ITEM_TIMESTAMP', STATUS_INVENTORY_ITEM FROM tbl_inventory WHERE INVENTORY_ITEM_CODE LIKE 'PAST%' AND STATUS_INVENTORY_ITEM = 'ARCHIVED' ORDER BY INVENTORY_ITEM_EXP ASC;";
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Pastry Inventory Item List Archive - Buko Coolers Cafe</title>
    ...
    <body>
        ...
        <div class="form_container">
            <h1>PASTRY INVENTORY ITEMS LIST ARCHIVE</h1>
            <div class="table_container_nouppr">
                <div style="overflow-y: auto; height: 470px;">
                    <table class="dataview">
                        <thead>
                            <tr>
                                <th>Pastry Material Code</th>
                                <th>Pastry Material Description</th>
                                <th>Pastry Material Amount</th>
                                <th>Pastry Product Units</th>
                                <th>Pastry Material Cost of Goods</th>
                                <th>Pastry Material Expiry Date</th>
                                <th>Last Archived</th>
                                <th>STATUS</th>
                            </tr>
                        </thead>
