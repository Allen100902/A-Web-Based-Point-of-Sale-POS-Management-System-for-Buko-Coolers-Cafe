<?php
    ...
    if (isset($_GET['ProdID'])){
        ...
        if (isset($_POST['save_ret'])){
            ...
            $PROD_UDATE = "UPDATE tbl_products_list SET PROD_STATUS = '{$unavailable}', STATUS = '{$value_archive}', PROD_TIMESTAMP = NOW() WHERE PK_PROD_LIST='{$get_prodid}'";
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Confirm Archive Product - Buko Coolers Cafe</title>
    ...
    <body>
        ...
        <div class="form_container_archive">
            <fieldset class="form_product">
                ...
                <p>When you archive this product, this product will
                    no longer be selected when placing an order.<br>Are you sure you want to
                archive this product?</p>
                <br>
                <p>Click "ARCHIVE PRODUCT" to confirm archive this product<br>
                Click "CANCEL" to return to product list page</p>
                <form class="user_deact" method="POST" action="">
                    <div class="form_buttons_deact">
                        ...
                        <button type="submit" class="confirm_deact" name="save_ret">ARCHIVE PRODUCT</button>
                    </div>
                </form>
            </fieldset>
        </div>
