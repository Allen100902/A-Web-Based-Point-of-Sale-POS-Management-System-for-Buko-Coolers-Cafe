...
<!DOCTYPE html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Admin Notifications - Buko Coolers Cafe</title>
            ...
            <div class="table_container_nouppr">
                <div style="overflow-y: auto; height: 450px;">
                    <table class="dataview">
                        <ul>
                            <?php
                                $notif_query = "SELECT NOTIF_TITLE, NOTIF_INFO, DATE_FORMAT(DATE_ADD(NOTIF_TIMESTAMP, INTERVAL 8 HOUR), '%Y-%m-%d %r') AS 'NOTIF_TIMESTAMP' from tbl_notifications ORDER BY NOTIF_ID DESC;";
