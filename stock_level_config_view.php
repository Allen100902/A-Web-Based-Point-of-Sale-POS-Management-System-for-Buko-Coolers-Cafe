...
<!DOCTYPE html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>View Stock Level Configuration - Buko Coolers Cafe</title>
    ...
    <body>
        ...
        <div class="form_container">
            <h1>STOCK LEVEL CONFIGURATION</h1>
                                ...
                                <?php
                                    if (mysqli_num_rows($exec_showinventory) > 0) {
                                        while($row = mysqli_fetch_assoc($exec_showinventory)){
                                            ...
                                            echo "<td><a href='stock_level_config_modify.php?InventoryID={$ret_inventory_id}' onclick='return confirm(\"Are you sure do you want to confirm change stock level threshold?\");';><i class='material-icons'>settings</i></a></td>";
                                            echo "</tr>";
                                        }
                                    } else {
                                        echo "<tr>
                                            <td colspan='8'>No Inventory Item items found.</td>
                                            </tr>";
                                    }
                                ?>
                            </tr>
