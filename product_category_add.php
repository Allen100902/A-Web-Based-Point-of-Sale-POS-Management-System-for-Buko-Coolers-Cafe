<?php
    ...
    if (isset($_POST['save_ret'])){
        ...
        $PRODCAT_ADD = "INSERT INTO tbl_prod_categories(PROD_CAT_NAME) VALUES ('{$PRODUCT_CATEGORY_NAME}')";
        $EXEC_PRODCAT_ADD = mysqli_query($databaseconn, $PRODCAT_ADD);
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Add Product Category - Buko Coolers Cafe</title>
            ...
            <div class="user_form">
                <form class="user_data_entry" method="POST" action="">
                    <fieldset class="form_product_cat">
                        ...
                        <div class="form_row">
                            <input type="text" name="prodcatname" id="prodcat_name" placeholder="Enter new product category here" required>
                        </div>
                    </fieldset>
                    <div class="form_buttons">
                        <button type="reset" class="reset_btn">Clear Fields</button>
                        <button type="submit" class="take_action" name="save_ret">Add Product Category</button>
                    </div>
                </form>
            </div>
        </div>
