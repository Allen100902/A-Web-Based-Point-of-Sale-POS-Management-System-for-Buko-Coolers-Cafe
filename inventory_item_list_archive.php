<?php
    ...
    FROM tbl_inventory_materials_list WHERE INVENTORY_ITEM_STATUS = 'ARCHIVED' ORDER BY tbl_inventory_materials_list.PK_INVENTORY DESC";
...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Inventory Items List Archive - Buko Coolers Cafe</title>
    ...
    <body>
        ...
        <div class="form_container">
            <h1>INVENTORY MATERIALS LIST ARCHIVE</h1>
                            ...
                            <tr>
                                <?php
                                    if (mysqli_num_rows($exec_show_inventory_list) > 0) {
                                        ...
                                        echo "<tr>
                                        <td colspan='5'>No Inventory Materials found.</td>
                                        </tr>";
                                    }
                                ?>
                            </tr>
