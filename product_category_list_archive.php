<?php
    ...
    $archive_check = "SELECT PK_PROD_CAT, PROD_CAT_NAME, PROD_CAT_STATUS, DATE_FORMAT(DATE_ADD(PROD_CAT_TIMESTAMP, INTERVAL 8 HOUR), '%Y-%m-%d %r') AS 'PROD_CAT_TIMESTAMP' FROM tbl_prod_categories WHERE PROD_CAT_STATUS = 'ARCHIVED' ORDER BY PROD_CAT_TIMESTAMP DESC";
...
<!DOCTYPE html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Product Category Archives - Buko Coolers Cafe</title>
    ...
    <body>
        ...
        <div class="form_container">
            <h1>PRODUCT CATEGORY ARCHIVES</h1>
                                ...
                                <?php
                                    if (mysqli_num_rows($exec_showarchive) > 0) {
                                        while($row = mysqli_fetch_assoc($exec_showarchive)){
                                            ...
                                            echo "<td>$ret_prodcat_status</td>";
                                            echo "<td>$ret_prodcat_udate</td>";
                                            echo "</tr>";
                                        }
                                    } else {
                                        echo "<tr>
                                            <td colspan='3'>No archived product categories found.</td>
                                            </tr>";
                                    }
                                ?>
                            </tr>
