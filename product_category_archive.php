<?php
    ...
    if (isset($_GET['ProdCatID'])){
        ...
        if (isset($_POST['save_ret'])){
            ...
            $USR_UDATE = "UPDATE tbl_prod_categories SET PROD_CAT_STATUS = '{$value_archive}', PROD_CAT_TIMESTAMP = NOW() WHERE PK_PROD_CAT = $get_prodcatid";
...
<!DOCTYPE html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Confirm Archive Product Category - Buko Coolers Cafe</title>
    ...
    <body>
        ...
        <div class="form_container_archive">
            <fieldset class="form_product">
                ...
                <p>When you archive this product category, this product category will
                    no longer be selected when adding a product.<br>Are you sure you want to
                archive this product category?</p>
                <br>
                <p>Click "ARCHIVE PRODUCT CATEGORY" to confirm archive this product category<br>
                Click "CANCEL" to return to product category settings page</p>
                <form class="user_deact" method="POST" action="">
                    <div class="form_buttons_deact">
                        ...
                        <button type="submit" class="confirm_deact" name="save_ret">ARCHIVE PRODUCT CATEGORY</button>
                    </div>
                </form>
            </fieldset>
        </div>
